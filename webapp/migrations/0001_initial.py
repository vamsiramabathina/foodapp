# -*- coding: utf-8 -*-
# Generated by Django 1.11.27 on 2020-06-15 10:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(b'Waiting', b'Waiting'), (b'Placed', b'Placed'), (b'Acknowledged', b'Acknowledged'), (b'Completed', b'Completed'), (b'Cancelled', b'Cancelled'), (b'Dispatched', b'Dispatched')], default=b'Waiting', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('r_logo', models.FileField(upload_to=b'')),
